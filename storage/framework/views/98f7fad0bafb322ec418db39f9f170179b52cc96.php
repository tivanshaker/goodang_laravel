...
<?php $__env->startSection('content'); ?>
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?php echo e(route('exportPDF.productMasukAll')); ?>" class="btn btn-danger">Export PDF</a>
            <a href="<?php echo e(route('exportExcel.productMasukAll')); ?>" class="btn btn-success">Export Excel</a>
        </div>
        ...
        <div class="box-body">
            <table id="invoice" class="table table-striped">
                ...
                <?php $__currentLoopData = $invoice_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td>
                        <a href="<?php echo e(route('exportPDF.productMasuk', [ 'id' => $i->id ])); ?>" class="btn btn-sm btn-danger">Export PDF</a>
                    </td>
                    </tbody>
    ...
    <?php echo $__env->make('product_masuk.form', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
